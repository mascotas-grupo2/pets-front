...
> El paso de ubicación usa **OpenStreetMap + Leaflet** (tiles) y **Nominatim** (geocoding), ambos gratuitos y sin API key. Se respeta el límite de Nominatim con debounce de 500 ms al tipear.
...
- [components/site-header.tsx](components/site-header.tsx) — Navbar con links de navegación, botón _Reportar_ y CTA condicional (_Ingresar_ / _Mi Cuenta_) según sesión en Redux.
