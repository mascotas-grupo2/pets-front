...
/**
 * Dropdown propio (reemplaza al <select> nativo, que renderiza el listado feo del
 * SO). Buscable, accesible por teclado y consistente con el design system.
 */
export function SegSelect<V extends string | number>({
  id,
  value,
  options,
  placeholder,
  ...
  return (
    <div className="seg-combo" ref={rootRef} onKeyDown={onKeyDown}>
      <button
        type="button"
        id={id}
