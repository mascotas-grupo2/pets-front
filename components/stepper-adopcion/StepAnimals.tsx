    ...
    <>
      ...
      <div className="form-grid">
        ...
        {formik.values.hasAllergies === "si" && (
          <div className="field full">
            <label className="field-label">
              Contanos los detalles de las alergias
            </label>
            <textarea
              className="textarea"
              name="allergies"
              ...
              placeholder="Ej: Mi hijo es alérgico a los gatos..."
            />
          </div>
        )}
        ...
        <div className="field">
          ...
          <small style={{ color: "var(--gray-500)", fontSize: "0.8rem", marginTop: "4px", display: "block" }}>
            Si no lo están, el porcentaje de compatibilidad puede bajar para asegurar la tenencia responsable.
          </small>
        ...
        <div className="field full">
          ...
          />
          <small style={{ color: "var(--gray-500)", fontSize: "0.8rem", marginTop: "4px", display: "block" }}>
            Algunas mascotas con necesidades especiales o perros jóvenes requieren familias con mayor experiencia previa.
          </small>
        </div>
      </div>
    </>
